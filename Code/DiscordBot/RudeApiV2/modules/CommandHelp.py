...
class Help(commands.Cog):
    ...
    async def command_help(self, ctx, *, arg=''):
        ...
        if arg == 'all':
            embed.add_field(name='Administrators commands',
                        value='**!setAdmin [user_id]**\tAdd "Rudebot Manager" role to a user.\n' \
                        '**!delAdmin [user_id]**\tDelete the "Rudebot Manager" role to a user.\n' \
                        '**!admins**\tDisplays the list of managers.',
                        inline=False)
        ...
        embed.add_field(name='Documentation',
            ...
            inline=False)
        embed.set_image(url='https://github.com/JoshuaMeza/CodePain_POO/blob/master/Resources/RudeApiLogo.png?raw=true')
